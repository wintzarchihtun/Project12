...
class ProjectTaskType(models.Model):
    ...
    rating_template_id = fields.Many2one(
        ...
        domain=[('model', '=', 'project.task')],
        help="If set and if the project's rating configuration is 'Rating when changing stage', then an email will be "
             "sent to the customer when the task reaches this step.")
...
class Task(models.Model):
    ...
    planned_hours = fields.Float("Planned Hours",help='It is the time planned to achieve the task. If this document has sub-tasks, it means the time needed to achieve this tasks and its childs.',track_visibility='onchange', readonly=False )
